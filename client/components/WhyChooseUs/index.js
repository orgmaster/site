    ...
    return (
        <Section bg="red" align="center" gradient>
          ...
          <Carousel
            ...
            >
                <DarkCard fixedHeight={carouselHeight} title="Calidad" lightLevel={1} className="mx-4 shadow-md">
                    <p>
                ...
                <DarkCard fixedHeight={carouselHeight} title="Precio" lightLevel={2} className="mx-4 shadow-md">
                    <p>
                ...
                <DarkCard fixedHeight={carouselHeight} title="Garantía" lightLevel={3} className="mx-4 shadow-md">
                    <p>
                        Nuestro software tiene <strong>garantía de por vida</strong>. Cubriendo cualquier desconformidad en lo acordado.
                    </p>
                </DarkCard>
                <DarkCard fixedHeight={carouselHeight} title="Confianza" lightLevel={4} className="mx-4 shadow-md">
                    <p>
                ...
                <DarkCard fixedHeight={carouselHeight} title="Ágil" lightLevel={4} className="mx-4 shadow-md">
                    <p>
                        Utilizamos <strong>metodologías ágiles</strong>, permitiendo acelerar el tiempo y organizar los proyectos.
                    </p>
                </DarkCard>
                <DarkCard fixedHeight={carouselHeight} title="Demos semanales" lightLevel={3} className="mx-4 shadow-md">
                    <p>
                ...
                <DarkCard fixedHeight={carouselHeight} title="Servidor de pruebas" lightLevel={2} className="mx-4 shadow-md">
                    <p>
