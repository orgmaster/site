    ...
    return (
        <Section bg="red" align="center" gradient>
          <Title h2 align="center" color="white">¿Por qué elegirnos?</Title>
            ...
            >
                <DarkCard title="Calidad" lightLevel={1} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                ...
                <DarkCard title="Precio" lightLevel={2} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                ...
                <DarkCard title="Garantía" lightLevel={3} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                        Nuestro software tiene <strong>garantía de por vida</strong>. Cubriendo cualquier desconformidad en lo acordado.
                    </p>
                </DarkCard>
                <DarkCard title="Confianza" lightLevel={4} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                ...
                <DarkCard title="Ágil" lightLevel={4} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                        Utilizamos <strong>metodologías ágiles</strong>, permitiendo acelerar el tiempo y organizar los proyectos.
                    </p>
                </DarkCard>
                <DarkCard title="Demos semanales" lightLevel={3} className="mx-2 sm:mx-4 shadow-md">
                    <p>
                ...
                <DarkCard title="Servidor de pruebas" lightLevel={2} className="mx-2 sm:mx-4 shadow-md">
                    <p>
